    ...
    <main className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-sm px-6">
        <div className="text-center mb-10">
          ...
          <p className="text-typewriter text-white/40 text-sm">
        ...
        <form onSubmit={onSubmit} className="space-y-4">
          ...
          <button className="btn-primary w-full" disabled={busy}>
            {busy ? "Logging in…" : "Continue with Email"}
          </button>
        </form>
        ...
        <p className="text-center mt-8">
          <span className="text-typewriter text-white/30 text-xs">
            New here?{" "}
            <Link href="/signup" className="text-white/60 underline underline-offset-4 decoration-white/20 hover:text-white/80 transition">
              Create an account
            </Link>
          </span>
        </p>
